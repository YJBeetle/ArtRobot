...
int main(int argc, char *argv[]) {
    // Rectangle
    {
        ...
        ArtRobot::Renderer renderer(ArtRobot::OutputType::Png, 512, 512, ArtRobot::Renderer::PX, 72);
    ...
    // Group
    {
        ...
        g2.addChild(c2);
        g2.addChild(g1);
        ArtRobot::Renderer renderer(ArtRobot::OutputType::Pdf, 512, 512, ArtRobot::Renderer::PX, 72);
    ...
    // Anchor
    {
        ...
        for (const auto &c: cl)
            g.addChild(c);
        ArtRobot::Renderer renderer(ArtRobot::OutputType::Png, 400, 400, ArtRobot::Renderer::PX, 72);
