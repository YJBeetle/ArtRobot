...
int main(int argc, char *argv[]) {
    ...
    // Anchor
    {
        ArtRobot::Component::Circle cl[] = {
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::LT}, 200, 200, ArtRobot::Color::Red),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::CT}, 200, 200, ArtRobot::Color::Lime),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::RT}, 200, 200, ArtRobot::Color::Blue),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::LC}, 200, 200, ArtRobot::Color::Yellow),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::CC}, 200, 200, ArtRobot::Color::Aqua),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::RC}, 200, 200, ArtRobot::Color::Fuchsia),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::LD}, 200, 200, ArtRobot::Color::Purple),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::CD}, 200, 200, ArtRobot::Color::Teal),
                ArtRobot::Component::Circle("Circle", {.anchor=ArtRobot::Transform::RD}, 200, 200, ArtRobot::Color::Navy),
        };
